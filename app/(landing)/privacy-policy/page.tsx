  ...
  return (
    <div className="translations-content-container">
      <div className="container">
        <div className="prose lg:prose-xl prose-invert" id="en">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to EndMonthEvent.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Kazakhstan
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to EndMonthEvent, accessible
                from{" "}
                <a
                  href="endmonthevent.vercel.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  endmonthevent.vercel.app
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                ...
                data-cfemail="1c7d72697d6e6f747d75787972736a5c7b717d7570327f7371"
              >
